...
```{r opts, comment="", prompt=TRUE, echo=FALSE, message=FALSE, warning=FALSE, error=FALSE}
library(knitr)
...
```{r, dev='png', fig.height=400, fig.width=400, cache=TRUE}
slices <- c(50, 50) 
...
* *RGL* `r citep(bib["rgl"])` using *R* - http://cran.r-project.org/
...
## Biblio
```{r biblio, results='asis', eval=FALSE}
bibliography("html") 
```
---
